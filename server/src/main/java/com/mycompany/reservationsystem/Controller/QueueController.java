...
import com.mycompany.reservationsystem.Config.WebSocketBroadcaster;
import com.mycompany.reservationsystem.dto.NotificationDTO;
...
public class QueueController {
    ...
    public String loginViaLink(
        ...
        return "redirect:/loginpage" + (logout != null ? "?logout=" + logout : "");
    }
    ...
    public String cancelReservation(HttpSession session) {
        ...
        if (reservation != null) {
            ...
            if (reservation.getTable() != null) {
                ManageTables table = reservation.getTable();
